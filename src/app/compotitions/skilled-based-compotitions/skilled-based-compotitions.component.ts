...
@Component({
  selector: 'app-skilled-based-compotitions',
  templateUrl: './skilled-based-compotitions.component.html',
  styleUrls: ['./skilled-based-compotitions.component.css']
})
export class SkilledBasedCompotitionsComponent implements OnInit {
  ...
  setPromo(){
    for(var i = 0; i < this.allCompotitions.length; i++){
      if(this.allCompotitions[i].category === 'skilledBased' && this.allCompotitions[i].active != 0){
