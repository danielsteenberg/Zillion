...
@Component({
  selector: 'app-survey-based-compotitions',
  templateUrl: './survey-based-compotitions.component.html',
  styleUrls: ['./survey-based-compotitions.component.css']
})
export class SurveyBasedCompotitionsComponent implements OnInit {
  ...
  setPromo(){
    for(var i = 0; i < this.allCompotitions.length; i++){
      if(this.allCompotitions[i].category === 'surveyBased' && this.allCompotitions[i].active != 0){
