...
@Component({
  selector: 'app-directory-compotitions',
  templateUrl: './directory-compotitions.component.html',
  styleUrls: ['./directory-compotitions.component.css']
})
export class DirectoryCompotitionsComponent implements OnInit {
  ...
  setPromo(){
    for(var i = 0; i < this.allCompotitions.length; i++){
      if(this.allCompotitions[i].category === 'compotitionDirectory' && this.allCompotitions[i].active != 0){
