...
$competitions = mysqli_query($con,"SELECT * FROM `entered_competitions` where userId='$userId'");
while($row = mysqli_fetch_assoc($competitions))
  $allCompetitions[] = $row;
$rowsAll = mysqli_num_rows($competitions);

// echo json_encode($allUsers);
echo json_encode($allCompetitions);
